...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(997);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_DynamicFAIcon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8051);
...
/* harmony import */ var _middlewares_authorizationPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7406);
...
async function getServerSideProps(context) {
    const { token  } = await (0,_middlewares_authorizationPage__WEBPACK_IMPORTED_MODULE_5__/* .authorizationPage */ .zD)(context);
...
function Admin(props) {
    const { 0: links , 1: setLinks  } = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(props.links);
    ...
    async function deleteHandler(id, e) {
        e.preventDefault();
        const msg = await sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
        ...
        if (msg.isConfirmed) {
            const linksFiltered = links.filter((link)=>{
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire("Deleted!", "Your file has been deleted.", "success");
                return link.id !== id && link;
            });
            setLinks(linksFiltered);
            const deleteReq = await fetch("https://linktree.decorunic.id/api/links/delete?id=" + id, {
                method: "DELETE",
                headers: {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire("Cancelled", "Your imaginary file is safe :)", "error");
            return;
        }
    }
    const editHandler = (id, e)=>{
        e.preventDefault();
        next_router__WEBPACK_IMPORTED_MODULE_3___default().push("/admin/edit?id=" + id);
    };
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("section", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                                ...
                                onClick: ()=>next_router__WEBPACK_IMPORTED_MODULE_3___default().push("/admin/create"),
