...
async function handler(req, res) {
    ...
    const update = await (0,_libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("links").where({
        id
    }).update({
        name,
        url,
    ...
    // console.log(update);
    const updatedData = await (0,_libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("links").where({
        id
    }).first();
    res.status(200);
    res.json({
...
var __webpack_exports__ = __webpack_require__.X(0, [305], () => (__webpack_exec__(6980)));
